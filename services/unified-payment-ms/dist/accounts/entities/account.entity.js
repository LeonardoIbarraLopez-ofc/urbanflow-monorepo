...
__decorate([
    (0, typeorm_1.Column)({ type: 'numeric', precision: 12, scale: 2, default: 0, transformer: numericTransformer }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => transaction_entity_1.PaymentTransaction, (tx) => tx.account),
